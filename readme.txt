...
the output_cnots (432), added_cnots (192), ratio := output_cnots/num_cnot (4.28), and time (1.8"). 
...
B. Initial mapping (line 19)
	One can select mapping from {'top', 'wgt', 'empty', 'naive'}
	The default mapping is 'top'
...
D. Architecture graph AG (line 18)
    One can select AG from {'tokyo', 'sycamore', 'rochester', 'q19x19'} and 
    may also define her own AG. The default AG is 'tokyo'
